...
a_O = 0;
a_G1 = a_O + cross(om1,v_G1) + cross(al1,r_O_G1);
a_E  = a_O + cross(om1,v_E)  + cross(al1,r_O_E);
a_G2 = a_E + cross(om2,v_G2) + cross(al2,r_E_G2);
...
%%%% where M is a 2x2 matrix alpha = [ud1 ud2] 
